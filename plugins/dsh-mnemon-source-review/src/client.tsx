...
export function Page(props: MemorySourcePageProps) { return <><RecordActionPanel {...props} options={controls} /><History {...props} writable={false} /><Settings {...props} /></> }
export function apply(ctx: MemorySourceUIContext): void { installMemorySourceUI(ctx, { sourceTypeId: 'review', pages: [{ id: 'review', label: '会话审核 / Review', order: 48, component: Page, navigation: { group: 'sources', primary: true } }] }) }
