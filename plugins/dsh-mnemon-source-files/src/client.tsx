...
export function apply(ctx: MemorySourceUIContext): void { installMemorySourceUI(ctx, { sourceTypeId: 'files', pages: [{ id: 'files', label: '文件检索 / Files', order: 45, component: Page, navigation: { group: 'sources', primary: true } }] }) }
